...
public class Tabuleiro {  //  mudado para public
    private Peca[][] casas;

    public Tabuleiro() {  //  mudado para public
        casas = new Peca[8][8];
        inicializar();
    }
    ...
    public Peca getPeca(int linha, int coluna) {  //mudado para public
        if (linha < 0 || linha > 7 || coluna < 0 || coluna > 7) return null;
        return casas[linha][coluna];
    }

    public void moverPeca(Peca p, int linha, int coluna) {  // mudado para public
